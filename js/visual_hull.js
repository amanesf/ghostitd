...
function stageVisualHull(opts){
  ...
  var result = P3D.carveRegion({
    ...
    SCALE: opts.SCALE, CX: opts.CX, CXBack: opts.CXBack, SCALEBack: opts.SCALEBack,
    YBOT: opts.YBOT, YBOTBack: opts.YBOTBack, SYTOP: opts.SYTOP, SYBOT: opts.SYBOT, SIDE_REF: opts.SIDE_REF,
